        ...
        <Reveal instant className="lg:col-span-7">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-6">
            ...
            <div className="text-sm">
              ...
              <a href={homeSection("levels")} className="btn-ghost">
            ...
            <Reveal key={it.t} delay={i * 60}>
              <article className="lift-card group relative h-full overflow-hidden rounded-[1.75rem] bg-white/90 border border-[#EAF0F6] shadow-[var(--shadow-soft)] backdrop-blur-sm">
                ...
                <div className="p-7 pt-5">
                  ...
                  <a href={homeSection("trial")} onClick={trackCtaClick} className="btn-ghost mt-5 text-sm">{t.courses.more} <ArrowRight className="h-3.5 w-3.5" /></a>
                </div>
              </article>
            </Reveal>
          ))}
        ...
        <Reveal>
          <div className="relative overflow-hidden rounded-[2.5rem] p-12 sm:p-20 text-center text-white" style={{ background: "linear-gradient(135deg,#20AAFD 0%, #21EEFC 100%)" }}>
            ...
            <div className="relative">
              ...
              <a href={homeSection("trial")} onClick={trackCtaClick} className="mt-9 inline-flex items-center justify-center gap-2 rounded-full bg-[#0F0F19] px-7 py-4 font-bold text-white shadow-[0_20px_50px_-10px_rgba(15,15,25,.5)] hover:-translate-y-1 transition-transform">
